...
class HomePage(QMainWindow):
    ...
    def nextPage(self):
        if self.itemOn == "Anime":
            ...
            self.mangaGlob = AniGlob(self.mangaGlob.MediaType, self.mangaGlob.per_page,
                                     self.mangaGlob.start_page + self.mangaGlob.per_page)
            self.mangaLayout()
    ...
    def animeLayout(self):
        ...
        GlobLists = {
            "Top Ranked": self.animeGlob.topRanked,
            "Top Popular": self.animeGlob.topPopular,
            "Top Trending": self.animeGlob.topTrend,
            "Top Favourites": self.animeGlob.topFavourites
        }
    ...
    def mangaLayout(self):
        ...
        GlobLists = {
            "Top Ranked": self.mangaGlob.topRanked,
            "Top Popular": self.mangaGlob.topPopular,
            "Top Trending": self.mangaGlob.topTrend,
            "Top Favourites": self.mangaGlob.topFavourites
        }
